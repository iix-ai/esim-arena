...
# Tiandao eSIM Generator V1.0 (Based on VPN V10.0 Stable)
# 适配：旅游绿配色, 飞机图标, eSIM专用字段, 域名修正

class ESIMGenerator:
    def __init__(self):
        self.base_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
        self.data_path = os.path.join(self.base_dir, 'data', 'esim_raw.csv') # 注意文件名
    ...
    def generate_index(self, esims):
        ...
        top_bar_html = f'''<div class="top-bar" onmouseover="document.getElementById('exitPopup').style.display='flex'">{self.config["top_bar"]["text"]}</div>''' if self.config['top_bar']['enabled'] else ""
        ...
        <body>
            ...
            <div class="exit-popup" id="exitPopup">
                <div class="popup-box">
                    ...
                    <a href="#ranking" class="btn" onclick="document.getElementById('exitPopup').style.display='none'" style="width:100%; box-sizing:border-box; margin-top:15px;">Claim Discount</a>
                </div>
            </div>
            <script>
    ...
    def generate_details(self, esims):
        ...
        for esim in esims:
            ...
            top_bar_html = f'''<div class="top-bar" onmouseover="document.getElementById('exitPopup').style.display='flex'">✈️ Traveling? Get 15% OFF eSIMs!</div>'''
    ...
    def run(self):
        self.log("🚀 Starting eSIM Generator V1.0...")
